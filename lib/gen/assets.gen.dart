...
class $AssetsImgIconsGen {
  ...
  /// File path: assets/img/icons/sp.svg
  SvgGenImage get sp => const SvgGenImage('assets/img/icons/sp.svg');

  /// File path: assets/img/icons/spider.svg
  SvgGenImage get spider => const SvgGenImage('assets/img/icons/spider.svg');
